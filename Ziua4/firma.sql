...
DROP PROCEDURE angajati_cu_salariu_mare;
DELIMITER //
CREATE PROCEDURE angajati_cu_salariu_mare(IN salariu_limita INT)
	BEGIN 
		DECLARE limita INT DEFAULT 5; 
        SELECT * FROM angajat 
			WHERE salariu > salariu_limita LIMIT limita;
	END //
DELIMITER ;


CALL angajati_cu_salariu_mare(1000);
